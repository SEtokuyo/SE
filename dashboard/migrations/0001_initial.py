    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('online_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='online_user', to=settings.AUTH_USER_MODEL)),
                ('staff_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='staff_user', to=settings.AUTH_USER_MODEL)),
